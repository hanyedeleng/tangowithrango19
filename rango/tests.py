...
class IndexPageTests(TestCase):
    ...
    def test_rango_picture_display(self):
...
class AboutPageTests(TestCase):
    ...
    def test_about_contain_message(self):
        # Check if is ther ean image on the about page
        # Chapter 4
        response = self.client.get(reverse('about'))
...
class ModelTests(TestCase):
    ...
    def setUp(self):
        try:
            ...
            print('The module pupulate_rango does not exiset')
        except NameError:
