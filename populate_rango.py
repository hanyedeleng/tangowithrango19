...
def populate():
    ...
    django_pages = [
            {"title": "Official Django Tutorial",
                "url":
                "https://docs.djangoproject.com/en/1.9/intro/tutorial101/"},
            {"title": "Django Rocks",
    ...
    # inforamtion about how to iterate over a dictionary properly.
    ...
    # print out the categories we have addes
